...
// DhritiTheme implements the Theme interface with Dhriti brand colors.
// It provides both dark and light variants.
type DhritiTheme struct {
	BaseTheme
}

// NewDhritiTheme creates a new instance of the Dhriti theme.
func NewDhritiTheme() *DhritiTheme {
	// Dhriti color palette
	// Dark mode colors
...
func init() {
	// Register the Dhriti theme with the theme manager
	RegisterTheme("dhriti", NewDhritiTheme())
}
