...
import (
	...
	"github.com/opencode-ai/dhriti/internal/app"
	"github.com/opencode-ai/dhriti/internal/config"
	"github.com/opencode-ai/dhriti/internal/llm/agent"
	"github.com/opencode-ai/dhriti/internal/logging"
	"github.com/opencode-ai/dhriti/internal/permission"
	"github.com/opencode-ai/dhriti/internal/pubsub"
	"github.com/opencode-ai/dhriti/internal/session"
	"github.com/opencode-ai/dhriti/internal/tui/components/chat"
	"github.com/opencode-ai/dhriti/internal/tui/components/core"
	"github.com/opencode-ai/dhriti/internal/tui/components/dialog"
	"github.com/opencode-ai/dhriti/internal/tui/layout"
	"github.com/opencode-ai/dhriti/internal/tui/page"
	"github.com/opencode-ai/dhriti/internal/tui/theme"
	"github.com/opencode-ai/dhriti/internal/tui/util"
)
...
func New(app *app.App) tea.Model {
	...
	model.RegisterCommand(dialog.Command{
		...
		Description: "Create/Update the Dhriti.md memory file",
		Handler: func(cmd dialog.Command) tea.Cmd {
			prompt := `Please analyze this codebase and create a Dhriti.md file containing:
1. Build/lint/test commands - especially for running a single test
2. Code style guidelines including imports, formatting, types, naming conventions, error handling, etc.

The file you create will be given to agentic coding agents (such as yourself) that operate in this repository. Make it about 20 lines long.
If there's already a dhriti.md, improve it.
