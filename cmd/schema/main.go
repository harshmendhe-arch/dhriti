...
func generateSchema() map[string]any {
	schema := map[string]any{
		...
		"title":       "Dhriti Configuration",
		"description": "Configuration schema for the Dhriti application",
		"type":        "object",
	...
	// Add remote WebSocket gateway (OpenAI Realtime-shaped)
	schema["properties"].(map[string]any)["gateway"] = map[string]any{
		"type":        "object",
		"description": "Remote WebSocket gateway speaking the OpenAI Realtime protocol. When url is set, all LLM traffic routes through it and local OpenAI/Gemini API keys are not required.",
		"properties": map[string]any{
			"url": map[string]any{
				"type":        "string",
				"description": "WebSocket endpoint (ws:// or wss://) for the gateway",
			},
			"apiKey": map[string]any{
				"type":        "string",
				"description": "Optional bearer token sent to the gateway",
			},
			"model": map[string]any{
				"type":        "string",
				"description": "Optional model name sent as ?model= (defaults to stream model or gpt-realtime)",
			},
		},
		"required": []string{"url"},
	}
		...
		"additionalProperties": map[string]any{
			...
			"properties": map[string]any{
				...
				"reasoningEffort": map[string]any{
					"type":        "string",
					"description": "Reasoning effort for models that support it (OpenAI)",
